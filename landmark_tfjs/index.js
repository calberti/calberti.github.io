...
async function predictPreloaded(elem) {
  // Make a prediction through the locally hosted alma_76.jpg.
  const almaElement = document.getElementById(elem);
...
const demo = async () => {
  ...
  predictPreloaded('teachers');
  predictPreloaded('butler');
  predictPreloaded('alma');
